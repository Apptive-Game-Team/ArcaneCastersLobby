 ...
 *
 * On this track `MagicQueryRepository` selects `m.indicator::text`, so no entity field
 * currently takes a decoded jsonb value. These two tests hold the registration in place
